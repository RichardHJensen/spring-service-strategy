...
@ContextConfiguration("classpath*:/service-one-wrapper-date-context.xml")
public class ServiceOneWrapperTest {
    @Autowired
    ...
    @Test
    public void shouldUseClassicIfOnlyOneDateIsOdd() {
        assertThat(serviceOne.operationThree(new LocalDate(2014, 1, 1), new LocalDate(2014, 2, 3)),
                is("ClassicServiceOne_14.8 -- operationThree(01/01/2014, 02/03/2014)"));
        assertThat(serviceOne.operationThree(new LocalDate(2014, 6, 10), new LocalDate(2014, 7, 15)),
                is("ClassicServiceOne_14.8 -- operationThree(06/10/2014, 07/15/2014)"));
